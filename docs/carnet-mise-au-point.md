# Carnet de mise au point — environnement, outils, câblage et commandes

Ce document contient tout ce qui était auparavant dans le `README.md` et qui n'y avait pas sa place :
les chemins de la machine de développement, l'emplacement des chaînes d'outils, les six firmwares de
diagnostic, le câblage provisoire, les commandes de compilation et le détail du protocole.

C'est un **carnet de travail**, pas une présentation. Il vaut pour la machine décrite ; sur une autre,
lire d'abord [migration-nouveau-pc.md](migration-nouveau-pc.md).

Références de conception :
[plan-projet-clim-toshiba-esp32.md](plan-projet-clim-toshiba-esp32.md) (les « §x.y » ci-dessous le
désignent), [cahier-des-charges-v2.md](cahier-des-charges-v2.md),
[api-v2.md](api-v2.md), [journal-de-tests.md](journal-de-tests.md).
...
[docs/migration-nouveau-pc.md](migration-nouveau-pc.md).
...
> [docs/journal-de-tests.md](journal-de-tests.md).
...
[docs/cahier-des-charges-v2.md](cahier-des-charges-v2.md).
...
[docs/api-v2.md](api-v2.md) : cinq routes, aucune surprise.
...
- **Un point d'arrêt peut être « maintenu »** (`lock`). Pendant ce segment, toute trame vue par le
  ...
  l'interface l'annonce, et le détail est dans [docs/api-v2.md](api-v2.md).
